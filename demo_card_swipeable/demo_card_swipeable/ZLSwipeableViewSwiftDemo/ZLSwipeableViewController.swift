...
class ZLSwipeableViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // 2. Thay thế Cartography bằng Native Auto Layout
                // Yêu cầu: View nằm giữa màn hình, rộng 80%, cao 60% view cha
                swipeableView.translatesAutoresizingMaskIntoConstraints = false
                NSLayoutConstraint.activate([
                    swipeableView.centerXAnchor.constraint(equalTo: view.centerXAnchor),
                    swipeableView.centerYAnchor.constraint(equalTo: view.centerYAnchor),
                    swipeableView.widthAnchor.constraint(equalTo: view.widthAnchor, multiplier: 0.8),
                    swipeableView.heightAnchor.constraint(equalTo: view.heightAnchor, multiplier: 0.6)
                ])
