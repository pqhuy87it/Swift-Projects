//
//  DynamicContentFlowLayoutDataSource.swift
//  CollectionView
//
...
class DynamicContentFlowLayoutDataSource: NSObject {
...
extension DynamicContentFlowLayoutDataSource: UICollectionViewDataSource {
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath)
        -> UICollectionViewCell {
            let dequeuedCell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath)
            guard let cell = dequeuedCell as? DynamicContentFlowLayoutCell else { return dequeuedCell }
