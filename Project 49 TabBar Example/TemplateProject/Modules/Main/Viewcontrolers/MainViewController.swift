...
class MainViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        items = [
            Subject(title: "Normal TabBar", description: "")
    ...
    func showNormalTabBar() {
        if let normalTabBarVC = NormalTabBarViewController.fromStoryboard(Storyboards.NormalTarBar.name) as? NormalTabBarViewController {
            self.present(normalTabBarVC, animated: true, completion: nil)
        }
    }
}
