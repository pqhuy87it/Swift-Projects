...
struct Device {
	...
	static var currentDeviceVersion: Float {
		struct Singleton {
			static var version = Float(UIDevice.current.systemVersion) ?? 0.0
		}
	...
	static func isSize(_ height: Heights) -> Bool {
		return currentDeviceHeight == height.value
	}
	...
	// MARK: 5.4 Inch Checks

	static func IS_5_4_INCHES() -> Bool {
		return isPhone() && isSize(.Inches_5_4)
	}

	static func IS_5_4_INCHES_OR_LARGER() -> Bool {
		return isPhone() && isSizeOrLarger(.Inches_5_4)
	}

	static func IS_5_4_INCHES_OR_SMALLER() -> Bool {
		return isPhone() && isSizeOrLarger(.Inches_5_4)
	}
	...
	// MARK: 6.1 Inch Checks

	static func IS_6_1_INCHES() -> Bool {
		return isPhone() && isSize(.Inches_6_1)
	}

	static func IS_6_1_INCHES_OR_LARGER() -> Bool {
		return isPhone() && isSizeOrLarger(.Inches_6_1)
	}

	static func IS_6_1_INCHES_OR_SMALLER() -> Bool {
		return isPhone() && isSizeOrLarger(.Inches_6_1)
	}

	// MARK: 6.5 Inch Checks

	static func IS_6_5_INCHES() -> Bool {
		return isPhone() && isSize(.Inches_6_5)
	}

	static func IS_6_5_INCHES_OR_LARGER() -> Bool {
		return isPhone() && isSizeOrLarger(.Inches_6_5)
	}

	static func IS_6_5_INCHES_OR_SMALLER() -> Bool {
		return isPhone() && isSizeOrLarger(.Inches_6_5)
	}

	// MARK: 6.7 Inch Checks

	static func IS_6_7_INCHES() -> Bool {
		return isPhone() && isSize(.Inches_6_7)
	}

	static func IS_6_7_INCHES_OR_LARGER() -> Bool {
		return isPhone() && isSizeOrLarger(.Inches_6_7)
	}

	static func IS_6_7_INCHES_OR_SMALLER() -> Bool {
		return isPhone() && isSizeOrLarger(.Inches_6_7)
	}
	...
	static func getDeviceName() -> String {
		...
		guard let deviceCode = DeviceCode(rawValue: code) else {
			return Device.otherDeviceType(with: code)
		}

		return deviceCode.deviceName()
	}

	static func getModel() -> DeviceCode {
		var size: Int = 0
		sysctlbyname("hw.machine", nil, &size, nil, 0)
		var machine = [CChar](repeating: 0, count: Int(size))
		sysctlbyname("hw.machine", &machine, &size, nil, 0)
		...
		return DeviceCode(rawValue: code) ?? DeviceCode.UnknownDevice
	}
