...
class MainViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        items = [
            Subject(title: "Attributed String", description: "")
    ...
    func showAttributedString() {
        if let vc = AttributedStringController.fromStoryboard(Storyboards.AttributedString.name) as? AttributedStringController {
